...
\addfigure{Use mean/median `healthy' value * 6 to extract only tiny proportion of pixels in healthy image}

\nb{Not particularly convincing, since a few more damaged acquisitions will skew this the other way. May be better to split into healthy vs unhealthy, at least then the arbitrariness is explicit!}
